...
[README (English version)](https://github.com/Original repository: LyleMi/Learn-Web-Hacking/blob/master/README.en.md)
...
笔者所学浅薄、精力有限，在整理笔记的过程中难免存在一些错误或是不完整的部分，正在逐步修正和补充。如果存在疏漏、错误，欢迎各位读者以[Issue](https://github.com/Original repository: LyleMi/Learn-Web-Hacking/issues/new)或者[PR](https://github.com/Original repository: LyleMi/Learn-Web-Hacking/pulls)的方式批评指正，感激不尽。
...
```bash
git clone https://github.com/Original repository: LyleMi/Learn-Web-Hacking.git
...
感谢所有的[贡献者](https://github.com/Original repository: LyleMi/Learn-Web-Hacking/graphs/contributors)。

### License
---

项目以CC0 1.0许可证发布，可以点击[这里](https://github.com/Original repository: LyleMi/Learn-Web-Hacking/blob/master/LICENSE)浏览全文。
...
This version includes modifications and upgrades by Mahesh Pinjarkar.
